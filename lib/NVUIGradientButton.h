...
@property (strong, nonatomic) UIColor *highlightedTextColor; // Default to textColor
@property (strong, nonatomic) UIColor *disabledTextColor; // Default to textColor
@property (strong, nonatomic) UIColor *textShadowColor; // Default to darkGray
@property (strong, nonatomic) UIColor *highlightedTextShadowColor; // Default to textShadowColor
